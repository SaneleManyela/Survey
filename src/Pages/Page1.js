              ...
              {questionsSurvey1.map((q, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell align="center">
                    <Radio checked={answers[index] === "true"} onChange={() => handleRadioChange(index, "true")} value="true" name={`q${index}`} />
                  </TableCell>
                  <TableCell align="center">
                    <Radio checked={answers[index] === "false"} onChange={() => handleRadioChange(index, "false")} value="false" name={`q${index}`} />
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
